            ...
            <div class="view-box">
                ...
                <table class="table table-striped display" id="userstable">
                    ...
                    <c:forEach items="${users}" var="user">
                        <jsp:useBean id="user" scope="page" type="com.uran.gamblingstation.model.User"/>
                        <tr>
                            ...
                            <td>${user.roles}</td>
                            <td>
                                <input type="checkbox" onchange="changeStatus(${id})" <c:if test="${user.enabled}">checked</c:if> id="${id}"/>
