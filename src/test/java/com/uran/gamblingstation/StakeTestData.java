...
public class StakeTestData {
    ...
    public static final Stake STAKE_4_WIN_WITH_AMOUNT =
            new Stake(null, USER_2, HORSE_4_WINS, 100.25, of(2016, Month.AUGUST, 5, 10, 9).truncatedTo(ChronoUnit.SECONDS), true, 105.25d, false);
    ...
    public static final Stake STAKE_5_WIN_WITH_AMOUNT =
            new Stake(null, USER_1, HORSE_4_WINS, 100.25, of(2016, Month.AUGUST, 5, 10, 10).truncatedTo(ChronoUnit.SECONDS), true, 105.25d, false);
